        ...
        <div class="w-100">
          <div class="d-flex justify-content-between">
            <span
              ...
              @blur="
                $emit('edit', item.aptId, 'petName', $event.target.innerHTML)
              "
              >{{ item.petName }}</span
            >
          ...
          <div class="owner-name">
            ...
            <span
              contenteditable="contenteditable"
              @blur="
                $emit('edit', item.aptId, 'petOwner', $event.target.innerHTML)
              "
              >{{ item.petOwner }}</span
            >
          </div>
          <div
            contenteditable="contenteditable"
            @blur="
              $emit('edit', item.aptId, 'aptNotes', $event.target.innerHTML)
            "
          >
            {{ item.aptNotes }}
          </div>
